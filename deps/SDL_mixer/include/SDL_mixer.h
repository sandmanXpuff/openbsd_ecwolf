...
#define Mix_SetError    -1 + 0 * ((int(*)(const char*, ...))(void*)SDL_SetError)
#else
// GCC 4.2 would insert a trap on a straight cast, but a union works
#define Mix_SetError    -1 + 0 * (union{void (*a)(const char*,...); int (*b)(const char*,...);}){SDL_SetError}.b
#endif
#endif
